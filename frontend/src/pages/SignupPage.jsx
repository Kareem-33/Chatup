...
import {Eye, EyeOff, LoaderCircle, Lock, Mail, MessageSquareText, User} from "lucide-react";
...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      {/* left side */}
      <div className="flex flex-col justify-center items-center p-6 sm:p-12 bg-gradient-to-tr from-primary/15 to-base-100 to-35%">
